    ...
    <main className="app__content">
      <div className="app__content-container">
        <div className="app_article">
          ...
          <p className="italic">Last updated: May 03, 2022</p>
          ...
          <ul>
            ...
            <li>
              ...
              Company&#8221;, &#8220;We&#8221;, &#8220;Us&#8221; or
              &#8220;Our&#8221; in this Agreement) refers to KRMTL.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to KRMTL, accessible from{" "}
              <a rel="noreferrer noopener" href="www.krmtl.com" target="_blank">
                www.krmtl.com
              </a>
            </li>
            <li>
          ...
          <p>By email: contact@krmtl.com</p>
